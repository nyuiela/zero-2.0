...
contract DeployNFT is Script {
    ...
    function deployZeroNft(address oracleMaster, address carRegistry, address reputation, address _auction) internal {
        zeroNft = new ZeroNFT(address(oracleMaster), address(reputation), address(carRegistry), address(_auction));
    }
}
