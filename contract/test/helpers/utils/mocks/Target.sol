...
import "../../../../src/Euler/vault/EthereumVaultConnector.sol";
...
contract Target {
    function callTest(
        ...
        require(
            !IEVC(evc).isControlCollateralInProgress(),
            "ct/controlCollateral-lock"
        );
        require(
