...
import {Governable} from "src/Euler/vault/Governable.sol";
...
contract EulerRouter is Governable, IPriceOracle {
    ...
    function govSetConfig(
        ...
        address quote,
        address oracle
    ) external onlyEVCAccountOwner onlyGovernor {
