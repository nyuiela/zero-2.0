...
import {BaseFactory} from "src/Euler/vault/BaseFactory.sol";
import {EulerRouter} from "src/Euler/vault/EulerRouter.sol";
...
contract EulerRouterFactory is BaseFactory {
    ...
    function deploy(address governor) external returns (address) {
        ...
        deploymentInfo[router] = DeploymentInfo(
            msg.sender,
