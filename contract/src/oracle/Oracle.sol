...
contract OracleMaster is IOracleMaster, Ownable, Pausable, ReentrancyGuard {
    ...
    address public brandPermissionManager;
    address public globalPermissionManager;
    IPermissionManager public globalPermissionManagerContract;
    ...
    //      bytes4(
    //          keccak256(
    //              "registerCarBrand(string,string,(uint256,uint256,uint256,uint256,uint256),address)"
    //          )
    //      );
    //  bytes4 public constant UPDATE_ORACLE_SELECTOR =
    //      bytes4(
    //          keccak256(
    //              "updateOracle(string,(uint256,uint256,uint256,uint256,uint256))"
    //          )
    //      );
    //  bytes4 public constant DEACTIVATE_ORACLE_SELECTOR =
    //      bytes4(keccak256("deactivateOracle(string)"));
    //  bytes4 public constant REACTIVATE_ORACLE_SELECTOR =
    //      bytes4(keccak256("reactivateOracle(string)"));
    //  bytes4 public constant BATCH_UPDATE_PRICES_SELECTOR =
    //      bytes4(keccak256("batchUpdatePrices(string[],uint256[])"));
    //  bytes4 public constant INCREMENT_PRODUCT_COUNT_SELECTOR =
    //      bytes4(keccak256("incrementProductCount(string)"));
    //  bytes4 public constant DECREMENT_PRODUCT_COUNT_SELECTOR =
        ...
        returns (address oracleAddress, address)
    {
        ...
        //oracle address
        address clonedPermission = brandPermissionManager.clone();
