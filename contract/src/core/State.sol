...
contract StateManager {
    ...
    // contructor
    constructor(address _profile, address _permission) {
        // require(_profile != address(0), "State: profile address is zero");
        // require(_permission != address(0), "State: permission address is zero");
        // require(_profile != _permission, "State: profile and permission cannot be same");
        // require(_profile != msg.sender, "State: profile cannot be the same as sender");
